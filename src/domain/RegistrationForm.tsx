  ...
  return (
    <form onSubmit={handleSubmit} className={className}>
      ...
      {formData.custody === 'self' ? (
        <div className=" xl:w-[60%] px-[30px] py-[12px] mb-4 bg-gradient-to-r from-[#3CADEF] to-[#3365C2] border border-[#E5E7EB] text-[#111827] text-[16px] rounded-full flex items-center justify-center hover:bg-[#F9FAFB] transition-colors w-[100%]">
